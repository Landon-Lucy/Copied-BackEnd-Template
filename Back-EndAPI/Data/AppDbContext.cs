...
public partial class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            // map employee table to rolebasedsecurity schema
            entity.ToTable("employee", "rolebasedsecurity");
        ...
        {
            // map employee_role table
            entity.ToTable("employee_role", "rolebasedsecurity");
        ...
        {
            // map role table
            entity.ToTable("role", "rolebasedsecurity");
            entity.HasKey(e => e.Id).HasName("role_pkey");
        });

        modelBuilder.Entity<RolePermission>(entity =>
        {
            // map role_permission table
            entity.ToTable("role_permission", "rolebasedsecurity");
        ...
        {
            // map permission table
            entity.ToTable("permission", "rolebasedsecurity");
